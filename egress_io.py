...
from kafka_egress_pb2 import KafkaProducerRecord
from kinesis_egress_pb2 import KinesisEgressRecord
from request_reply_pb2 import TypedValue
...
def kafka_egress_message(typename: str,
    ...
    typed_value.typename = "type.googleapis.com/io.sdk.egress.KafkaProducerRecord"
...
def kinesis_egress_message(typename: str,
    ...
    typed_value = TypedValue()
    typed_value.typename = "type.googleapis.com/io.sdk.egress.KinesisEgressRecord"
    typed_value.has_value = True
    typed_value.value = record.SerializeToString()
